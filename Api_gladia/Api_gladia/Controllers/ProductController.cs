...
namespace Api_gladia.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        // GET: api/Product
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Product>>> Gettbl_product()
        {
            return await _context.tbl_product.ToListAsync();
        }
        ...
        {
            return _context.tbl_product.Any(e => e.prod_id == id);
        }
    }
}
